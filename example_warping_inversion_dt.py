...
# run warping
m = warpingInversion(t, base, mon, rick, halfalpha, model_type, Nepochs=51, regs=regs, reg_coeffs=reg_coeffs, m0=None,
 iter_lim=250, show_flag=1, returninfo_flag=0, plot_flag=True)
